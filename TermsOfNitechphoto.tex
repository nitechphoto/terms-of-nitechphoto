...
\chapter{入部・退部}
    ...
    \section{退部}
        \begin{enumerate}
            \item 役員を除くすべての部員は部長または役員に退部の意思を表明することで任意の時期に退部することができる。
...
\chapter{役員}
    ...
    \section{役員の辞任・解任}\label{resignation}
        \begin{enumerate}
            \item 部長は、役員会で辞任の意思を表明し、全役員が出席する部会においてその出席者の過半数の承認が得られた場合、部長を辞任することができる。
            \item 部長以外の役員は、役員会で辞任の意思を表明し、部会にて当規約\ref{decision}に基づいた承認が得られた場合、辞任することができる。
            \item 当規約\ref{disciplinary}に違反するなど役員として不適格と認められた者は、全役員が出席する部会においてその出席者の過半数の承認が得られた場合、強制的に解任させられる。
...
\chapter{部会}
    ...
    \section{部会における審議・議決}\label{decision}
        \begin{enumerate}
            \item 部会の議決は他に定めのない限り、部員の3分の1以上が出席する部会において、その出席者の過半数の賛成によって可決され、過半数の反対によって否決されるものとする。ただし、賛成・反対が同数の場合は役員会における議決を部会の議決とする。
            ...
            \item 当規約における「正当な理由」の有無は、原則として部長または役員会がこれを判断する。
        \end{enumerate}
    ...
    \section{部費の管理・監査}
        \begin{enumerate}
            ...
            \begin{itemize}
                ...
                % \item xxx銀行 xxxx
            \end{itemize}
            \item 会計は当規約\ref{activity}1項にて定められた活動期間の最後の月の部会にて会計報告を行う。
