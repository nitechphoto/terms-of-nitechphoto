...
\chapter{部会}
    ...
    \section{部会における審議・議決}\label{decision}
        \begin{enumerate}
            \item {\bf 部会の議決は他に定めのない限り、部員の3分の1以上が出席する部会において、その出席者の過半数の賛成によって可決され、過半数の反対によって否決されるものとする。ただし、賛成・反対が同数の場合は役員会における議決を部会の議決とする。}
...
\chapter{免責}
    ...
    \section{個人情報・データの取扱い}
        \begin{enumerate}
            ...
            \item 部員は電磁的記録媒体で保存されているデータが喪失したとしても一切の責任を負わない。
...
\chapter{その他}
    ...
    \section*{発行}
        当規約は、発行日である 2026年4月1日から発効する。
        \begin{itemize}
            \item 2026年4月1日：当規約の発行
        \end{itemize}
